function calculatePayments(){
    var vehiclePrice = document.getElementById('vehiclePrice').value,
        ...
        if(!annInterest){
          annInterest = 0;
          intRate = document.getElementById('intRate').value = '0';
        }
        ...
        results.innerHTML = '<h1 style="text-align:center">Estimated Monthly Payment is:<br/></h1>' + '<h3 style="text-align:center">Rs' + calc + '/Month</h3>';
